...
class SignalExtractor:
    def __init__(self, stock_map_path=config.STOCK_MAP_PATH):
        ...
        # 关键词定义 (扩展)
        self.buy_keywords = ['买入', '建仓', '上车', '低吸', '抄底', '加仓', '买点', '进场', '新入', '做新', '打板', '接力', '埋伏', '看好', '继续持有', '强势', '拉板', '涨停', '起飞', '梭哈', '满仓', '重点', '核心', '龙头', '主升', '突破', '放量', '金叉', '主升浪']
        self.sell_keywords = ['卖出', '清仓', '止盈', '止损', '下车', '跑路', '减仓', '出货', '离场', '落袋', '清了', '走了', '割肉', '止跌', '回落', '破位']
        self.negative_words = ['不买', '别买', '谨慎', '观望', '减仓', '止盈', '止损', '跑了', '清了', '不操作', '不追', '不接', '先看', '等待']
        self.author_weights = {
            '九哥实盘日记': 0.9,
            '松风论龙头': 0.8,
            '小匠财': 0.7,
